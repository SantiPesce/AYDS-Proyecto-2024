...
require 'bcrypt'
users = [
  { username: 'jondoe', email: 'jon@doe.com', password: BCrypt::Password.create('abc'), progress: 1, progress2: 14,
    actualLearning: 1, actualLearningLevel2: 15, correctAnswerCounter: 0, incorrectAnswerCounter: 0 },
  { username: 'janedoe', email: 'jane@doe.com', password: BCrypt::Password.create('abc'), progress: 1, progress2: 14,
    actualLearning: 1, actualLearningLevel2: 15, correctAnswerCounter: 0, incorrectAnswerCounter: 0 },
  { username: 'babydoe', email: 'baby@doe.com', password: BCrypt::Password.create('abc'), progress: 1, progress2: 14,
    actualLearning: 1, actualLearningLevel2: 15, correctAnswerCounter: 0, incorrectAnswerCounter: 0 },
  { username: 'superadmin', email: 'admin@gmail.com', password: BCrypt::Password.create('superadmin'), progress: 13,
    progress2: 19, actualLearning: 12, actualLearningLevel2: 19, correctAnswerCounter: 10, incorrectAnswerCounter: 10 }
]
...
learnings = [
  ...
  { number: 8, lesson: 'Los elementos en el mismo período muestran tendencias similares en sus propiedades.',
    levelImage: 'periodos' },
  { number: 9,
    lesson: 'La tabla periódica se divide en bloques según la secuencia en la que se llenan los orbitales
 de electrones.', levelImage: 'bloques' },
  { number: 10, lesson: 'Los bloques s, p, d y f de la tabla periódica contienen diferentes tipos de elementos.',
    levelImage: 'bloques' },
  { number: 11,
    lesson: 'Los elementos se clasifican en metales, metaloides y no metales según sus propiedades
físicas y químicas.', levelImage: 'clasificacion' },
  { number: 12,
    lesson: 'Los metales y no metales pueden subdividirse en categorías que muestran una gradación en sus
propiedades.', levelImage: 'clasificacion' },
  { number: 13,
  ...
  { number: 16, lesson: 'Algunos elementos son naturales, otros son sintéticos y se han creado artificialmente.',
    levelImage: 'elemento' },
  { number: 17,
    lesson: 'El descubrimiento de algunos elementos ha sido revocado o cuestionado debido a la dificultad de
 reproducir los experimentos.', levelImage: 'elemento' },
  { number: 18,
    lesson: 'Los elementos reciben nombres basados en griego, latín, inglés, descubridores o
lugares de descubrimiento.', levelImage: 'elemento' },
  { number: 19,
    lesson: 'Los elementos son sustancias puras que consisten en átomos con el mismo número atómico
y propiedades únicas.', levelImage: 'elemento' }
]

learnings.each do |h|
  Learning.create(h) unless Learning.exists?(h)
end
...
questions = [
  ...
  { number: 10, level: 1,
    enunciation: '¿Con que letras de denominan los distintos bloques a los que pertenecen los elementos de la
tabla periodica?' },
  { number: 11, level: 1,
...
questions.each do |q|
  Question.create(q) unless Question.exists?(q)
end
...
options = [
  ...
  { question_id: 6, correct: false,
    enunciation: 'Todos los elementos en la tabla periódica se organizan de acuerdo a su número atómico sin
ninguna excepción.' },
  { question_id: 6, correct: false,
    enunciation: 'La tabla periódica sigue un orden estricto basado únicamente en las propiedades físicas
de los elementos.' },
  ...
  { question_id: 14, correct: false,
    enunciation: 'Metales de transición y lantánidos - clasificados por su configuración electrónica y uso
en la industria.' },

...
require 'bcrypt'
users = [
  { username: 'jondoe', email: 'jon@doe.com', password: BCrypt::Password.create('abc'), progress: 1, progress2: 15,
    actualLearningLevel1: 1, actualLearningLevel2: 15, correctAnswerCounter: 0, incorrectAnswerCounter: 0 },
  { username: 'janedoe', email: 'jane@doe.com', password: BCrypt::Password.create('abc'), progress: 1, progress2: 15,
    actualLearningLevel1: 1, actualLearningLevel2: 15, correctAnswerCounter: 0, incorrectAnswerCounter: 0 },
  { username: 'babydoe', email: 'baby@doe.com', password: BCrypt::Password.create('abc'), progress: 1, progress2: 15,
    actualLearningLevel1: 1, actualLearningLevel2: 15, correctAnswerCounter: 0, incorrectAnswerCounter: 0 },
  { username: 'superadmin', email: 'admin@gmail.com', password: BCrypt::Password.create('superadmin'), progress: 1,
...
learnings = [
  { lesson: 'La tabla periódica clasifica los elementos químicos según su número atómico y propiedades químicas.',
    levelImage: 'tabla' },
  { lesson: 'Los elementos se organizan en filas (períodos) y columnas (grupos) según sus propiedades.',
  ...
  { lesson: 'Los períodos de la tabla periódica representan los niveles energéticos de los átomos.',
    levelImage: 'periodos' },
  { lesson: 'Los elementos en el mismo período muestran tendencias similares en sus propiedades.',
    levelImage: 'periodos' },
  {
    lesson: 'La tabla periódica se divide en bloques según la secuencia en la que se llenan los orbitales de electrones.
    ', levelImage: 'bloques'
  },
  {
  ...
  { lesson: 'Los bloques s, p, d y f de la tabla periódica contienen diferentes tipos de elementos.',
    levelImage: 'bloques' },
  {
  ...
  { lesson: 'Los elementos no metales se subdividen en no metales poliatómicos, no metales diatómicos y gases nobles.',
    levelImage: 'clasificacion' },
  { lesson: 'Los elementos se clasifican en categorías y subcategorías según sus propiedades compartidas.',
    levelImage: 'clasificacion' },
  { lesson: 'Los elementos son tipos de materia formados por átomos con el mismo número atómico.',
    levelImage: 'elemento' },
  { lesson: 'Algunos elementos son naturales, otros son sintéticos y se han creado artificialmente.',
    levelImage: 'elemento' },
  {
  ...
  {
    lesson: 'Los elementos reciben nombres basados en griego, latín, inglés, descubridores o lugares de descubrimiento
    .', levelImage: 'elemento'
  },
  {
    lesson: 'Los elementos son sustancias puras que consisten en átomos con el mismo número atómico y propiedades únicas
    .', levelImage: 'elemento'
  }
]
